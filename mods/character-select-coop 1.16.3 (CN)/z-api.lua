...
local function character_add(name, description, credit, color, modelInfo, baseChar, lifeIcon, camScale, showName2)
    name = type(name) == TYPE_STRING and name or "Untitled"
    credit = type(credit) == TYPE_STRING and credit or "Unknown"
    showName = type(showName2) == TYPE_STRING and showName2 or nil
...
local function character_add_costume(charNum, name, description, credit, color, modelInfo, baseChar, lifeIcon, camScale, showName)
    ...
    table.insert(characterTable[charNum], {
        ...
        showName = type(showName) == TYPE_STRING and showName or nil
    })
...
---@param lifeIcon TextureInfo|string? Use get_texture_info
---@param camScale integer? Zooms the camera based on a multiplier (Default `1`)
local function character_edit_costume(charNum, charAlt, name, description, credit, color, modelInfo, baseChar, lifeIcon, camScale, showName)
    ...
    characterTable[charNum][charAlt] = characterTable[charNum][charAlt] and {
        ...
        camScale = type(camScale) == TYPE_INTEGER and camScale or tableCache.camScale,
        healthMeter = tableCache.healthMeter,
        showName = type(showName) == TYPE_STRING and showName or tableCache.showName
    } or nil
...
---@param lifeIcon TextureInfo|string? Use get_texture_info
---@param camScale integer? Zooms the camera based on a multiplier (Default `1`)
local function character_edit(charNum, name, description, credit, color, modelInfo, baseChar, lifeIcon, camScale, showName)
    character_edit_costume(charNum, characterTable[charNum] and characterTable[charNum].currAlt or 1, name, description, credit, color, modelInfo, baseChar, lifeIcon, camScale, showName)
end
...
---@description 修改/添加某一个角色组的 showName
---@added 1.16.3 CN-rc3
---@param charNum integer The number/table position of the Character you want to get the nickname of
---@param charAlt The number/table position of the Costume you want to edit, this can be found by making a variable equal
---@param showName 对应角色汉化的内容
local function character_edit_costume_showName(charNum, charAlt, showName)
    if type(showName) == TYPE_STRING then characterTable[charNum][charAlt].showName = showName end
end

---@description 修改此角色的 showName
---@added 1.16.3 CN-rc3
---@param charNum integer The number/table position of the Character you want to get the nickname of
---@param showName 对应角色汉化的内容
local function character_edit_showName(charNum, showName)
    if type(showName) == TYPE_STRING then characterTable[charNum].showName = showName end
end
...
_G.charSelect = {
    ...
    character_edit_showName = character_edit_showName,
    character_edit_costume_showName = character_edit_costume_showName,
