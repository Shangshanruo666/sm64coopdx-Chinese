-- name: Character Select 1.16.3 (CN-rc3)
-- description:\\#ffff33\\-- Character Select Coop v1.16.3 CN-rc3 --\n\n\\#dcdcdc\\A Library / API made to make adding and using Custom Characters as simple as possible!\nUse\\#ffff33\\ /char-select\\#dcdcdc\\ to get started!\n\nChinese prodby \\#00adff\\toad\\#ffad00\\X\\#00ff78\\tech\\#ff3500\\64\\#dcdcdc\\\nThanks bzcdNoise make graffiti CN Version\nAnd earlier translator xiao-Link&Shangshanruo!\n\nCreated by:\\#008800\\ Squishy6094\n\n\\#AAAAFF\\Updates can be found on\nCharacter Select's Github:\n\\#6666FF\\Squishy6094/character-select-coop
-- pausable: false
-- category: cs
...
local TEXT_TABLE_MENU_BINDS = {
    [MENU_BINDS_DEFAULT] = {
        {bind = "上 / 下",    desc = "切换角色"},
        {bind = "左 / 右", desc = "切换服装"},
        {bind = "A 键",     desc = "设置首选角色"},
        {bind = "B 键",     desc = "退出菜单"},
        {bind = "X 键",     desc = "切换为网格视图"},
        {bind = "Y 键",     desc = "切换配色"},
        {bind = "L/R 扳机", desc = "切换分类"},
        {bind = "开始键", desc = "选项菜单"},
    },
    [MENU_BINDS_GRID] = {
        {bind = "上 / 下 / 左 / 右", desc = "切换角色"},
        {bind = "A 键",     desc = "设置首选角色"},
        {bind = "B 键",     desc = "退出菜单"},
        {bind = "X 键",     desc = "切换为列表视图"},
        {bind = "Y 键",     desc = "切换配色"},
        {bind = "L/R 扳机", desc = "切换分类"},
        {bind = "开始键", desc = "选项菜单"},
    },
    [MENU_BINDS_OPTIONS] = {
        {bind = "上 / 下",    desc = "滚动"},
        {bind = "左 / 右", desc = "切换选项"},
        {bind = "开始 / B 键", desc = "退出选项菜单"},
    },
    [MENU_BINDS_CREDITS] = {
        {bind = "上 / 下",    desc = "滚动"},
        {bind = "左 / 右", desc = "切换页面"},
        {bind = "开始 / B 键", desc = "退出贡献者菜单"},
    },
}
...
characterTable = {
    [CT_MARIO] = {
        ...
        [1] = {
            name = "Mario",
            description = "一位普通的意大利人! 他勇敢且自信, 经常用他擅长的跳跃能力来拯救蘑菇王国!",
    ...
    [CT_LUIGI] = {
        ...
        [1] = {
            name = "Luigi",
            description = "另一位意大利人! 他有点害羞和胆小, 但是他愿意和他的兄弟马力欧一同面对任何可能到来的战斗!",
            credit = "Nintendo / CoopDX",
    ...
    [CT_TOAD] = {
        ...
        [1] = {
            name = "Toad",
            showName = "奇诺比奥",
            description = "蘑菇王国随处可见的小可爱! 特点是长的像一个蘑菇, 经常会在冒险路上给予马力欧和路易吉帮助!",
            credit = "Nintendo / CoopDX",
    ...
    [CT_WALUIGI] = {
        ...
        [1] = {
            name = "Waluigi",
            showName = "瓦路易吉",
            description = "路易吉的对手! 他是个自恋的竞争者, 对他人因他的成功而受挫感到极大的满足!",
            credit = "Nintendo / CoopDX",
    ...
    [CT_WARIO] = {
        ...
        [1] = {
            name = "Wario",
            showName = "瓦力欧",
            description = "马力欧的对手！他是个充满贪欲的宝藏猎人，痴迷于金钱和金币。如果他的钱财缺斤少俩，那你可就得小心了!",
            credit = "Nintendo / CoopDX",
...
optionTable = {
    [optionTableRef.openInputs] = {
        ...
        toggleDefault = 1,
        toggleMax = 2,
        toggleNames = {"无", "按下 Z 键", ommActive and "按下 D-Pad 下 + R" or "按下 D-Pad 下"},
        description = {"设置一个快捷键来打开菜单", "而不是使用命令"}
    },
    ...
    [optionTableRef.menuColor] = {
        ...
        toggleDefault = 0,
        toggleMax = 10,
        toggleNames = {"自适应", "保存的配色",  "红色", "橙色", "黄色", "绿色", "蓝色", "粉色", "紫色", "白色", "黑色"},
        description = {"设置你的菜单颜色"}
    },
    [optionTableRef.music] = {
        ...
        toggleDefault = 1,
        toggleMax = 3,
        toggleNames = {"关", "开", "仅休息房", "仅角色"},
        description = {"切换在什么时间", "播放菜单背景音乐"}
    },
    ...
    [optionTableRef.localVoices] = {
        ...
        toggleMax = 2,
        toggleNames = {"关", "开", "仅本地"},
        description = {"设置部分有特殊语音的角色", "是否有语音"}
    },
    [optionTableRef.localVisuals] = {
        ...
        toggleDefault = 1,
        toggleMax = 1,
        description = {"当对应角色模组可以修改", "物体和纹理时", "可以打开或关闭该功能"}
    },
    [optionTableRef.localMoveset] = {
        ...
        toggleDefault = 1,
        toggleMax = 1,
        description = {"当对应角色动作集", "可用且兼容时", "可以打开或关闭该动作集"},
        lock = function ()
    ...
    [optionTableRef.restrictMovesets] = {
        ...
        toggleDefault = 0,
        toggleMax = 1,
        description = {"限制所打开的", "动作集", "(仅房主支持修改)"},
        lock = function ()
    ...
    [optionTableRef.resetSaveData] = {
        ...
        toggleDefault = 0,
        toggleMax = 1,
        toggleNames = {"重置保存数据", "重置保存数据"},
        description = {"重置 Character Select 的", "保存数据"}
    },
    [optionTableRef.credits] = {
        ...
        toggleDefault = 0,
        toggleMax = 1,
        toggleNames = {"打开开发人员菜单", "打开开发人员菜单"},
        description = {"感谢您选择", "Character Select!"}
    },
}
...
creditTable = {
    [1] = {
        packName = "Character Select 1.16.3 CN",
        { creditee = "Squishy6094",     credit = "创始人" },
        { creditee = "Trashcam",        credit = "菜单背景音乐" },
        { creditee = "Charity",         credit = "音效设计" },
        { creditee = "JerThePear",      credit = "菜单资产/动画" },
        { creditee = "Shell_x33",       credit = "菜单资产" },
        { creditee = "WinbowBreaker",   credit = "预渲染菜单资产" },
        { creditee = "toadXtech64", credit = "现汉化维护者" },
        { creditee = "xiao_Link", credit = "早期汉化维护者" },
        { creditee = "上善若", credit = "早期汉化维护者" },
        { creditee = "bzcd noise", credit = "涂鸦贴图汉化" },
        { creditee = "SLG5", credit = "涂鸦贴图汉化" },
    }
}

if CREDIT_SUPPORTERS ~= nil then
    creditTable[0] = {
        packName = "Character Select 支持者 (包括CN)",
    }
...
local function reset_options(wasChatTriggered)
    if not promptedAreYouSure then
        djui_chat_message_create("\\#ffdcdc\\你确定要重置所有 Character Select 的保存数据吗？(包括预设角色和设置数据)\n" .. (wasChatTriggered and "输入 \\#ff3333\\/char-select reset\\#ffdcdc\\ 以确认." or "按下 \\#ff3333\\" .. optionTable[optionTableRef.resetSaveData].name .. "\\#ffdcdc\\ 选项以确认" ))
        ...
        djui_chat_message_create("\\#ff3333\\Character Select 设置已经重置!")
        djui_chat_message_create("Note: 如果您的问题尚未解决，您可能需要通过以下目录手动删除您的保存数据:\n\\#dcdcFF\\%appdata%/sm64coopdx/sav/character-select-coop.sav")
...
local function boot_note()
    ...
    if charCount > 0 then
        djui_chat_message_create("Character Select 有 " .. charCount .. " 个角色可用" .. (charCount > 1 and "" or "") .."\n你可以使用 \\#ffff33\\/char-select \\#ffffff\\打开菜单!")
        if charCount > 32 and network_is_server() then
            djui_chat_message_create("\\#FFAAAA\\警告:角色超过32个可能会导致\n一些不稳定的情况,\n所以请卸下一些角色包!")
        end
    else
        djui_chat_message_create("Character Select已初始化! \n你可以用 \\#ffff33\\/char-select \\#ffffff\\指令打开菜单!")
    end
end
...
local function mario_update(m)
    ...
    if m.playerIndex == 0 then
        ...
        -- p.showNameAll = charTable.showName and charTable.showName nil
...
local TEXT_VERSION = "版本: " .. MOD_VERSION_STRING .. "(CN-" .. cnver .. ") | sm64coopdx" .. (seasonalEvent == SEASON_EVENT_BIRTHDAY and (" | 今天是 Character Select 的" .. tostring(yearsOfCS) .. " 周年!") or "")
local TEXT_RATIO_UNSUPPORTED = "你目前的窗口比例不支持!"
local TEXT_PAUSE_Z_OPEN = "Z 键 - Character Select"
local TEXT_PAUSE_UNAVAILABLE = "Character Select 不可用"
local TEXT_PAUSE_CURR_CHAR = "使用角色: "
local TEXT_MOVESET_RESTRICTED = "动作集被限制"
local TEXT_PALETTE_RESTRICTED = "调色板被限制"
local TEXT_MOVESET_AND_PALETTE_RESTRICTED = "动作集和调色板被限制"
...
if math.random(100) == 64 then
    ...
    TEXT_PAUSE_CURR_CHAR = "模型: "
end

--Options/Credits Text
local TEXT_LOCAL_MODEL_ERROR = "无法找到角色模型"
local TEXT_LOCAL_MODEL_ERROR_FIX = "请验证模组包的完整性!"
...
local function on_hud_render()
    ...
    if menuAndTransition then
        ...
        if palettes then
            ...
            local paletteName = (palettes.currPalette == 0) and "自定义" or (palettes[palettes.currPalette].name or ("Palette "..palettes.currPalette))
            djui_hud_set_font(FONT_RECOLOR_HUD)
        ...
        if not gridMenu then
            ...
            for i = 0, #characterTableRender do
                ...
                if i >= currCharScoll - 3 and i <= currCharScoll + 3 then -- Only render if visible
                    ...
                    local showName = charTable.showName and charTable.showName or nil
                    -- 判断实际长度（for showName)
                    if showName ~= nil then
                        charNameLength = djui_hud_measure_text(showName)
                    elseif charTable[1].showName ~= nil then
                        charNameLength = djui_hud_measure_text(charTable[1].showName)
                    end
                    local altshowName = char.showName and char.showName or nil
                    ...
                    if showName then
                        djui_hud_print_text(showName, x + 120*scale + segments*16*scale*0.1 - charNameLength*cnScale*0.1, y + 36*scale, cnScale)
                    elseif charTable[1].showName ~= nil then
                        djui_hud_print_text(charTable[1].showName, x + 120*scale + segments*16*scale*0.1 - charNameLength*cnScale*0.1, y + 37*scale, cnScale)
                    else
                    ...
                    if altshowName ~= nil then
                        djui_hud_print_text(altshowName, x + segments*16*scale + 112*scale - djui_hud_measure_text(altshowName)*0.3*scale, y + 85*scale, 0.3*scale)
                    else
        ...
        if options == OPTIONS_MAIN then
            ...
            djui_hud_set_font(FONT_ALIASED)
            djui_hud_set_color(255, 255, 255, 255)
            djui_hud_print_text("选项", tvX + 13, tvY + 2, 0.5)
            djui_hud_set_font(FONT_NORMAL)
            local optionCategory = "... " .. string.upper(optionData.category)
            djui_hud_print_text(optionCategory, tvX + 13 + djui_hud_measure_text("选项")*0.5, tvY + 8, 0.25)
...
local function chat_command(msg)
    ...
    if msg == "?" or msg == "help" then
        djui_chat_message_create("Character Select 可用命令:" ..
        "\n\\#ffff33\\/char-select help\\#ffffff\\ - 返回可用命令" ..
        "\n\\#ffff33\\/char-select menu\\#ffffff\\ - 打开菜单" ..
        "\n\\#ffff33\\/char-select [name/num]\\#ffffff\\ - 切换角色" ..
        "\n\\#ff3333\\/char-select reset\\#ffffff\\ - 重置数据")
        return true
    end
    ...
    if not menu_is_allowed() or charBeingSet then
        djui_chat_message_create("角色无法被更改")
        return true
    end
        ...
        if characterTable[i].locked ~= LOCKED_TRUE then
            ...
            for a = 1, #characterTable[i] do
                if msg == string.lower(characterTable[i][a].name) or msg == saveName then
                    ...
                    djui_chat_message_create('已成功设置角色为 "' .. characterTable[i][characterTable[i].currAlt].name ' !')
                    return true
                end
            end
        end
    ...
    if tonumber(msgSplit[1]) then
        ...
        if charNum > 0 and charNum <= #characterTable and characterTable[charNum].locked ~= LOCKED_TRUE then
            ...
            djui_chat_message_create('已成功设置角色为 "' .. characterTable[charNum][altNum].name .. '" !')
            return true
        end
    end

    djui_chat_message_create("无法找到角色")
    return true
end

hook_chat_command("char-select", "- 打开 Character Select 菜单", chat_command)
